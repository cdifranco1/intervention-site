  ...
  return (
    <div className="py-10 px-8 bg-gray-100">
      ...
      <div className="flex flex-col items-center md:items-start md:flex-row md:justify-between">
        <div className="mb-7 md:m-0 md:w-3/8 relative">
